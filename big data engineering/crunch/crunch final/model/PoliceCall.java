...
public class PoliceCall extends
     ...
     */
    public PoliceCall(java.lang.Integer priority,
                      java.lang.CharSequence call_type, java.lang.CharSequence jurisdiction,
                      java.lang.CharSequence dispatch_area, java.lang.Long receive_time,
                      java.lang.Long dispatch_time, java.lang.Long arrival_time,
                      java.lang.Long clear_time, java.lang.CharSequence disposition) {
    ...
    public void put(int field$, java.lang.Object value$) {
        ...
        case 0:
            ...
            break;
        case 1:
            call_type = (java.lang.CharSequence)value$;
            break;
        case 2:
            jurisdiction = (java.lang.CharSequence)value$;
            break;
        case 3:
            dispatch_area = (java.lang.CharSequence)value$;
            break;
        case 4:
            receive_time = (java.lang.Long)value$;
            break;
        case 5:
            dispatch_time = (java.lang.Long)value$;
            break;
        case 6:
            arrival_time = (java.lang.Long)value$;
            break;
        case 7:
            clear_time = (java.lang.Long)value$;
            break;
        case 8:
            disposition = (java.lang.CharSequence)value$;
            break;
        default:
            throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
     ...
     * The call priority   * @param value the value to set.
     */
     ...
     * The type of police call   * @param value the value to set.
     */
     ...
     * The jurisdiction of the agency responsible for responding to the call   * @param value the value to set.
     */
     ...
     * The dispatch area of the police call   * @param value the value to set.
     */
     ...
     * The time the call was received   * @param value the value to set.
     */
     ...
     * The time since epoch the call was dispatched   * @param value the value to set.
     */
     ...
     * The time since epoch of the police arrival   * @param value the value to set.
     */
     ...
     * The time since epoch that the police left   * @param value the value to set.
     */
     ...
     * The final disposition of the call   * @param value the value to set.
     */
    ...
    public static model.PoliceCall.Builder newBuilder(
        model.PoliceCall.Builder other) {
    ...
    public static class Builder extends
        org.apache.avro.specific.SpecificRecordBuilderBase<PoliceCall>
        ...
        private Builder(model.PoliceCall.Builder other) {
            ...
            if (isValidValue(fields()[1], other.call_type)) {
                this.call_type = data().deepCopy(fields()[1].schema(),
                                                 other.call_type);
                fieldSetFlags()[1] = true;
            }
            if (isValidValue(fields()[2], other.jurisdiction)) {
                this.jurisdiction = data().deepCopy(fields()[2].schema(),
                                                    other.jurisdiction);
                fieldSetFlags()[2] = true;
            }
            if (isValidValue(fields()[3], other.dispatch_area)) {
                this.dispatch_area = data().deepCopy(fields()[3].schema(),
                                                     other.dispatch_area);
                fieldSetFlags()[3] = true;
            }
            if (isValidValue(fields()[4], other.receive_time)) {
                this.receive_time = data().deepCopy(fields()[4].schema(),
                                                    other.receive_time);
                fieldSetFlags()[4] = true;
            }
            if (isValidValue(fields()[5], other.dispatch_time)) {
                this.dispatch_time = data().deepCopy(fields()[5].schema(),
                                                     other.dispatch_time);
                fieldSetFlags()[5] = true;
            }
            if (isValidValue(fields()[6], other.arrival_time)) {
                this.arrival_time = data().deepCopy(fields()[6].schema(),
                                                    other.arrival_time);
                fieldSetFlags()[6] = true;
            }
            if (isValidValue(fields()[7], other.clear_time)) {
                this.clear_time = data().deepCopy(fields()[7].schema(),
                                                  other.clear_time);
                fieldSetFlags()[7] = true;
            }
            if (isValidValue(fields()[8], other.disposition)) {
                this.disposition = data().deepCopy(fields()[8].schema(),
                                                   other.disposition);
        ...
        /** Sets the value of the 'call_type' field */
        public model.PoliceCall.Builder setCallType(java.lang.CharSequence
                value) {
        ...
        /** Sets the value of the 'jurisdiction' field */
        public model.PoliceCall.Builder setJurisdiction(java.lang.CharSequence
                value) {
        ...
        /** Sets the value of the 'dispatch_area' field */
        public model.PoliceCall.Builder setDispatchArea(java.lang.CharSequence
                value) {
        ...
        /** Sets the value of the 'disposition' field */
        public model.PoliceCall.Builder setDisposition(java.lang.CharSequence
                value) {
        ...
        public PoliceCall build() {
            try {
                ...
                record.priority = fieldSetFlags()[0] ? this.priority :
                                  (java.lang.Integer) defaultValue(fields()[0]);
                record.call_type = fieldSetFlags()[1] ? this.call_type :
                                   (java.lang.CharSequence) defaultValue(fields()[1]);
                record.jurisdiction = fieldSetFlags()[2] ? this.jurisdiction :
                                      (java.lang.CharSequence) defaultValue(fields()[2]);
                record.dispatch_area = fieldSetFlags()[3] ? this.dispatch_area :
                                       (java.lang.CharSequence) defaultValue(fields()[3]);
                record.receive_time = fieldSetFlags()[4] ? this.receive_time :
                                      (java.lang.Long) defaultValue(fields()[4]);
                record.dispatch_time = fieldSetFlags()[5] ? this.dispatch_time :
                                       (java.lang.Long) defaultValue(fields()[5]);
                record.arrival_time = fieldSetFlags()[6] ? this.arrival_time :
                                      (java.lang.Long) defaultValue(fields()[6]);
                record.clear_time = fieldSetFlags()[7] ? this.clear_time :
                                    (java.lang.Long) defaultValue(fields()[7]);
                record.disposition = fieldSetFlags()[8] ? this.disposition :
